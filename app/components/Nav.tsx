...
export const Nav = () => {
    ...
    return (
        ...
        >
            <nav className="w-[50%] flex justify-center gap-5 rounded-3xl bg-custom-white p-3 *:rounded-xl *:border text-black shadow-xl shadow-gray-900 ${playfair.className}">
                <a
                    href="#Home"
