...
const AuroraFooter = () => {
    ...
    return (
        <motion.section
            ...
            className="relative w-full min-h-screen flex justify-center items-center overflow-hidden bg-gray-950 px-4 py-24 text-gray-200"
        >
            ...
            {/* <div className="absolute inset-0 z-0">
                <Canvas>
                    <Stars radius={50} count={2500} factor={4} fade />
                </Canvas>
            </div> */}
        </motion.section>
    );
